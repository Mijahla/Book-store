...
<html lang="en">
    ...
    <body>
        ...
        <form action="php/edit-book.php" class="shadow p-4 rounded mt-5 class-for-add-book" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                    ...
                    <input type="text" hidden class="form-control" value="<?=$book['cover']?>" name="current_cover">              
            ...
            <div class="mb-3">
                    ...
                    <input type="text" hidden class="form-control" value="<?=$book['file']?>" name="current_file">              
